...
public class ClubVO {
	...
	private int club_cost, club_memtot, club_maxage, club_code;
	...
	public void setClubfile(MultipartFile clubfile) {
		...
		if(! clubfile.isEmpty()){
			...
			//***********************************************
			// 해당 경로로 변경
			File f = new File("C:\\Users\\microsoft\\git\\Mokoji\\mokoji\\src\\main\\webapp\\resources\\images\\"+club_rpic);
	...
	public void setClub_pic(String club_pic) {
		...
		System.out.println("클럽 pic" + club_pic );
	}
	...
	public void setClub_rpic(String club_rpic) {
		...
		System.out.println("클럽 rpic" + club_rpic );
	}
