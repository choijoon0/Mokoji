...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css?family=Inter%3A100%2C400%2C500" />
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css?family=Source+Sans+Pro%3A100%2C400%2C500" />
...
<body>
	...
	<div class="frame-16-WMF">
		<div class="auto-group-g4qr-dgm">
			...
			<div class="auto-group-1wzf-EgZ">
				...
				<form action="SignUp.do">
					<input type="submit" class="item--BvZ" id="confirm" value="회원가입"
						style="border: none; background: transparent;" />
				</form>
			</div>
		</div>
		...
		<div class="frame-45-AcH">
			<div class="rectangle-282-xHF"></div>
			<div class="rectangle-312-4LH"></div>
			<div class="line-79-nn5"></div>
			...
			<span class="id_ok">사용 가능한 아이디입니다.</span> <span class="id_already">누군가
				이 아이디를 사용하고 있어요.</span> <input type="button" id="jung" name="jung"
				style="border: none; background: transparent;" value="중복확인" />
			<div>
				<span id="result_checkId" style="font-size: 12px;"></span>
			</div>
			<div class="line-81-98m"></div>
			<div class="line-130-ebK"></div>
			<div class="line-131-P37"></div>
			<div class="line-132-KSZ"></div>

			<p class="item--4Q8">회원가입</p>
			<p class="item--4Q9">비밀번호</p>
			<div class="line-106-knm"></div>
			<input type="password" id="pass" name="MEM_PW" />
			
			<p class="item--4oT">본인 확인 이메일(선택)</p>
			<input id="email" type="text" name="email"></input>
			<p class="MEM_TEL">전화 번호</p>
			<input id="first" name="MEM_TEL"></input>
			<input id="second" name="MEM_TEL"></input>
			<input id="third" name="MEM_TEL"></input>
			...
			<div class="line-125-Peh"></div>
			<div class="line-126-Vhj"></div>
			<div class="item--S7B">-</div>
			<div class="item--S7A">-</div>
			<div class="line-127-uWZ"></div>
			<div class="item--pNd">-</div>
			<p class="MEM_JUMIN">주민번호</p>
			<div class="line-102-jumin"></div>
			<input type="text" id="juminA" name="ju_first" />
			<input type="text" id="juminB" name="ju_second" />
			<div class="line-102-yoF"></div>
			<p class="name">이름</p>
			<div class="line-101-CR7"></div>
			<input type="text" id="name" name="MEM_NAME" />
			<p class="item--LGR">비밀번호 재확인</p>
			<input type="password" id="passjea" name="passjea" />
			
			<div class="item--SMP">@</div>
			<select id="emailsun" name="emailselect">
			...
			<table>
				<tr>
					<th>주소</th>
					<td><input type="text" id="MEM_LOCA" name="address" readonly /></td>
				</tr>
				<tr>
					<th>상세 주소</th>
			...
			<img class="free-icon-search-interface-symbol-54481-1-jtD"
				src="../img/free-icon-search-interface-symbol-54481-1.png" />
			
				<div class="rectangle-436-T3X"></div>
				<input type="submit" id="join" name="join"
					style="border: none; background: transparent;" value="회원가입" />
			</form>
