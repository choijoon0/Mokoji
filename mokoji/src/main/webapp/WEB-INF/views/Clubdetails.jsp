										...
										<table>
											...
											<form action="joinClub.do">
												<div class="col-lg-12">
													...
													<!-- Button trigger modal -->
													<button id="newCinst" type="button" class="btn"
											...
											<form action="insertClubInstant.do" method="post">
												<div class="modal fade" id="cinstModal" tabindex="-1"
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h1 class="modal-title fs-5" id="exampleModalLabel">새
																	번개모임 생성</h1>
															</div>
															<div class="modal-body">
																...
																<fieldset>
																	<input name="cinst_name" type="text" id="cinst_name"
																		placeholder="번개모임 제목을 입력하세요*" required
																		autocomplete="off">
																</fieldset>
																<fieldset>
																	<input name="cinst_date" type="date" id="cinst_date"
																...
																<div>
																	<label id="yes"> <input type="radio"
																		name="cinstcost" onclick="textActive1()" value="있음">있음
																	</label> <label id="no"> <input type="radio"
																		name="cinstcost" onclick="textDisable1()" value="없음">없음
																	</label> <input type="text" name="cinst_cost" id="cinstpay"
																		placeholder="금액을 작성해주세요.">
																</div>
																<div class="col-lg-12">
																	<fieldset>
																		<textarea name="cinst_content" type="text"
																			class="form-control" id="cinst_content"
																			placeholder="번개글을 써주세요." required autocomplete="off"></textarea>
																	</fieldset>
																</div>
																<div class="per1">
																	<input name="cinst_memtot" type="number" min='3'
																		max='30' step='1'
																		placeholder="3명이상부터 30명 미만까지 작성해주세요.">
																</div>
															</div>
															<div class="modal-footer">
																<button type="submit" class="btn btn-primary">새
																	번개모임 생성</button>
																<button type="button" class="btn btn-secondary"
