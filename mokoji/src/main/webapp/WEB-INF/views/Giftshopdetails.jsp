...
<div class="card mb-3">
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">${glist.gcon_name}</h5>
        <input type="hidden" id="gcon_code" value="${glist.gcon_code}">
        <input type="hidden" id="point" value="${point}">
        <li class="card-text" value="${glist.gcon_price}">${glist.gcon_price}</li><a>point</a>
        <fieldset>
        ...
        <button type="button" id="submit">구매하기</button>
      </div>
    </div>
  </div>
  </c:forEach>
