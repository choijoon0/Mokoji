						...
						<div class="col-lg-12">
							<div class="row grid">
								...
								<section class="contact-us" method="post">
									<form action="inserting.do" method="post"
														...
														<div class="col-lg-12">
															<div id="contact">
																<div class="row">
																	...
																	<button type="submit" method="post">챌린지 생성</button>
									</form>
							</div>
						</div>
					</div>
									...
									<div class="row">
										...
										<div>
											<label id="yes"> <input type="radio"
												name="socialinfo_chpay" onclick="textActive()" value="있음">있음
											</label> <label id="no"> <input type="radio"
												name="socialinfo_chpay" onclick="textDisable()" value="없음">없음
										...
										<label class="item5">인원 수</label>
										<div class="per">
											<input name="social_tot" type="number" min='3' max='30'
												step='1'>
										</div>
									...
									<div class="col-lg-12">
										<fieldset>
											...
											<c:if test="${checknum < 1 }">
												<button type="submit" id="form-submit1" class="button">동호회
													생성</button>
											</c:if>
											<c:if test="${checknum >= 1}">
												<button type="button" class="noinsert" id="form-submit1"
													class="button">동호회 생성</button>
											</c:if>
